...
SYSTEM_EVENTS_REFRESH_MS = env_int("SYSTEM_EVENTS_REFRESH_MS", 2000)
...
RISK_YOLO_CLASSES = [0, 14, 15, 16, 24, 26, 28, 39]
...
FACE_ANALYSIS_WIDTH = env_int("FACE_ANALYSIS_WIDTH", 960)
...
PPE_PERSON_MIN_ASPECT_RATIO = env_float("PPE_PERSON_MIN_ASPECT_RATIO", 0.75)
...
PHONE_CONF = env_float("PHONE_CONF", 0.55)
PHONE_IMGSZ = 960
...
PHONE_AREA_REQUIRES_PERSON = True
PHONE_TRACK_TTL_SECONDS = env_float("PHONE_TRACK_TTL_SECONDS", 1.5)
...
RTSP_DUAL_STREAM_ENABLED = os.getenv(
    "RTSP_DUAL_STREAM_ENABLED",
    "True",
).lower() == "true"
RTSP_MAIN_STREAM_NAME = os.getenv("RTSP_MAIN_STREAM_NAME", "stream1")
RTSP_SUB_STREAM_NAME = os.getenv("RTSP_SUB_STREAM_NAME", "stream2")
